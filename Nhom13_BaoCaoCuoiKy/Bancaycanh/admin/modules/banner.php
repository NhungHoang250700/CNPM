        ...
        <div class="row input_content">
            ...
            <?php
                ...
                if(isset($_POST['Timkiem'])){
                    $tukhoa=$_POST['tukhoa'];
                    $sum_banner_page= !empty($_GET['per-page'])?$_GET['per-page']:10;
                    $current_page= !empty($_GET['page'])?$_GET['page']:1;
                    $offset=($current_page -1 ) * $sum_banner_page;
                    $sql_select_banner = mysqli_query($con,"SELECT * from banner where match(name_banner) against('+$tukhoa'in boolean mode) LIMIT $sum_banner_page OFFSET $offset");
                    ...
                    <a href="index_admin.php?admin_moc=Banner" class="btn btn-warning" id="return"><i class="fa fa-angle-left"></i> Trở lại</a>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?php if(($row_banner['active_banner'])==1){ echo "<i class='fa fa-check' style='color:green'></i>"; }else{echo "<i class='fa fa-close' style='color:red'></i>";}?>
                            </td>
                            <td>
