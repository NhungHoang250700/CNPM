        ...
        <div class="row input_content">
                ...
                <div class="col-4">
                    <form  method="POST" action="" enctype="multipart/form-data">
                        ...
                        <p class="submit">
                            ...
                            <a href="index_admin.php?admin_moc=Chuyenmuc" class="btn btn-warning"><i class="fa fa-angle-left"></i> Trở lại</a>
                        </p>
                    </form>
                </div>
            ...
            <?php
                ...
                if(isset($_POST['Timkiem'])){
                    ...
                    $sql_select_category = mysqli_query($con,"SELECT * from category where match(name_category) against('+$tukhoa'in boolean mode) LIMIT $sum_category_page OFFSET $offset");
                    ...
                    <a href="index_admin.php?admin_moc=Chuyenmuc" class="btn btn-warning" id="return"><i class="fa fa-angle-left"></i> Trở lại</a>
