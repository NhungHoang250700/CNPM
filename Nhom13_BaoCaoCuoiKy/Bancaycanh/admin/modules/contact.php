            ...
            if(isset($_GET['quanly'])=='capnhap'){
                ...
                <div class="col-4">
                    ...
                    <div class="form-field">
                            ...
                            <input name="tag-name" class="form-control" id="tag-name" type="text" value="<?php echo $row_update_contact['contactName']?>" size="40" aria-required="true">
                            <p>Tên riêng sẽ hiển thị trên trang mạng của bạn.</p>
                        </div>
                        <div class="form-field">
                            <label for="tag-address">Địa chỉ</label>
                            <input name="tag-address" class="form-control" id="tag-address" type="text" value="<?php echo $row_update_contact['contactAddress']?>" size="40" aria-required="true">
                        </div>
                        <div class="form-field">
                            <label for="tag-phone">Điện thoại</label>
                            <input name="tag-phone" class="form-control" id="tag-phone" type="text" value="<?php echo $row_update_contact['contactPhone']?>" size="40" aria-required="true">
                        </div>
                        <div class="form-field">
                            <label for="tag-email">Email</label>
                            <input name="tag-email" class="form-control" id="tag-email" type="text" value="<?php echo $row_update_contact['contactEmail']?>" size="40" aria-required="true">
                        </div>
                        <div class="form-field">
                            <label for="tag-tax">Mã thuế</label>
                            <input name="tag-tax" class="form-control" id="tag-tax" type="text" value="<?php echo $row_update_contact['contacsTaxCode']?>" size="40" aria-required="true">
                        </div>
                        ...
                        <div class="form-field ">
                            ...
                            <textarea name="map" class="form-control" id="map" rows="5" cols="50%"><?php echo $row_update_contact['contactMap']?></textarea>
                        </div>
            ...
            <?php
                ...
                <div class="col-4">
                    ...
                    <div class="form-field">
                        ...
                        <div class="form-field">
                            <label for="tag-email">Email</label>
                            <input name="tag-email" class="form-control" id="tag-email" type="text"  size="40" aria-required="true">
                        </div>
                        <div class="form-field">
                            <label for="tag-tax">Mã thuế</label>
                        ...
                        <div class="form-field ">
                            <label for="map">Bản đồ</label>
                            <textarea name="map" class="form-control" id="map" rows="5" cols="50%"></textarea>
                        </div>
                ...
                if(isset($_POST['Timkiem'])){
                    $tukhoa=$_POST['tukhoa'];
                    $sum_contact_page= !empty($_GET['per-page'])?$_GET['per-page']:10;
                    ...
                    <a href="index_admin.php?admin_moc=Lienhe" class="btn btn-warning" id="return"><i class="fa fa-angle-left"></i> Trở lại</a>
