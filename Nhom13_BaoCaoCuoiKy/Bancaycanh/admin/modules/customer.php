    ...
    <div class="container-fluid">
        ...
        <div class="row input_content">
                ...
                if(isset($_POST['Timkiem'])){
                    $tukhoa=$_POST['tukhoa'];
                    $sum_customerorder_page= !empty($_GET['per-page'])?$_GET['per-page']:10;
                    $current_page= !empty($_GET['page'])?$_GET['page']:1;
                    $offset=($current_page -1 ) * $sum_customerorder_page;
                    $sql_select_customerorder = mysqli_query($con,"SELECT A.*, B.*, concat(B.lastName,' ',B.firstName) as Name FROM orders A, customerorders B WHERE A.id_customerorder=B.id_customerorder AND A.id_customerorder like '%$tukhoa%' ORDER BY A.id_customerorder DESC LIMIT $sum_customerorder_page OFFSET $offset");
...
<tbody>
    <tr>
        ...
        <a href="index_admin.php?admin_moc=Chitiethoadon&idhd=<?php echo $row_customerorder['orderNumber']?>"><button class="btn btn-info btn-sm"><i class="fa fa-pencil"></i></button>
