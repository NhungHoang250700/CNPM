...
<head>
    ...
    <link rel="stylesheet" href="css/newproduct.css" class="css">
    ...
    <div class="form-wrap">
        ...
        <div class="form-field">
            ...
            <div class="form-field">
                ...
                <input name="tag-entered" data-success="right" type="text" class="form-context" required="required" size="40" aria-required="true">
            </div>
            <div class="form-field">
            ...
            <div class="form-field">
                ...
                <input name="tag-stock" data-success="right" type="text" class="form-context" required="required" size="40" aria-required="true">
            </div>

            <div class="form-field">
                <label for="tag-price">Mức giá</label>
                <input name="tag-price" data-success="right" type="text" class="form-context" required="required" size="40" aria-required="true">
            </div>
