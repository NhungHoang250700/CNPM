        ...
        <div class="row input_content">
                ...
                <div class="col-4">
                    ...
                    <div class="form-field">
                        ...
                        <p class="submit">
                            ...
                            <a href="index_admin.php?admin_moc=Danhmuc" class="btn btn-warning"><i class="fa fa-angle-left"></i> Trở lại</a>
                        </p>
                    </form>
                </div>
            ...
            <?php
                ...
                if(isset($_POST['Timkiem'])){
                    $tukhoa=$_POST['tukhoa'];
                    $sum_productline_page= !empty($_GET['per-page'])?$_GET['per-page']:10;
                    ...
                    <a href="index_admin.php?admin_moc=Danhmuc" class="btn btn-warning" id="return"><i class="fa fa-angle-left"></i> Trở lại</a>
