        ...
        <div class="row input_content">
            ...
            <?php
                ...
                if(isset($_POST['Timkiem'])){
                    ...
                    $sql_select_post = mysqli_query($con,"CALL PostByName('%$tukhoa%')");
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="nd_post"><?php echo $row_post['summery_post']?></td>
                           
                            <td>
                                <?php if(($row_post['status_display_post'])==1){ echo "<i class='fa fa-check' style='color:green'></i>"; }else{echo "<i class='fa fa-close' style='color:red'></i>";}?>
                            </td>
                            <td>
                    ...
                    ?>
                <?php
                    $sum_post_page= !empty($_GET['per-page'])?$_GET['per-page']:10;
