            ...
            <div class="form-field">
                ...
                <input name="tag-price" class="form-context" id="tag-price" type="text" value="<?php echo $row_update_product['buyPrice']?>" size="40" aria-required="true">
                        ...
                        <div class="form-field ">Tình trạng
                            ...
                            <?php
                            if($row_update_product['status']==1){ 
                                ?>
...
<tbody>
    <tr>
        ...
        <td>
            <?php if(($row_product['status'])==1){ echo "<i class='fa fa-check' style='color:green'></i>"; }else{echo "<i class='fa fa-close' style='color:red'></i>";}?>
        </td>
        <td>
