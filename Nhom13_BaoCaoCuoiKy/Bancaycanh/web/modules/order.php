...
if(isset($_POST['submit'])){
    ...
    $sql_customerorder=mysqli_query($con,"INSERT INTO customerorders(`firstName`, `lastName`, `phone`, `address`, `customerNumber`) VALUE('$ten','$ho','$sdt','$diachi',$idctm)");
        ...
        <div class="row">
                ...
                <div class="container ">
                    <div class="row">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                <input type="submit" name="submit" id="b3"  class="btn btn-dark d-block mx-auto btn-submit" value="Thanh toán">
                                <!-- <button type="button" id="btnSubmit" name="submit" class="btn btn-dark d-block mx-auto btn-submit">Submit</button> -->
                                
                                <!-- <script>
                                    document.getElementById('b3').onclick = function(){swal("Thanh toán thành công", "Click vào button!", "Thành công");};
                                </script> -->
                                </div>
                            </div>
                            </form>
            ...
            <div class="col-5">
                <div class="container d-flex justify-content-center mt-100">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <ul class="right" type="none">
                                        <li class="right"><?php echo date("d-m-Y");?></li>
                    ...
                    <div class="modal-footer"> <button type="button" class="btn"><a href="index.php?web_moc=Giohang">Track order</a></button> </div>
				</div>
            </div>
        </div>
    </div>
