...
<div class="row">
    ...
    $sql_select_product = mysqli_query($con,"SELECT A.*, B.* FROM products A, productlines B WHERE A.productLineCode=B.productLineCode AND A.status=1 ORDER BY productCode DESC LIMIT $sum_product_page OFFSET $offset");
