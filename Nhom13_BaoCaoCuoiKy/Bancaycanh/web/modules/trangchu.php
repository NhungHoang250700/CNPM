...
<!-- SẢN PHẨM MỚI -->
    <div class="product_new">
        <div class="pd-new">
            ...
            <div class="row ">
                <?php
                $sql_product_banchay= mysqli_query($con, "SELECT * FROM products A, productlines B WHERE A.productLineCode=B.productLineCode AND A.status=1 ORDER BY A.productCode DESC LIMIT 9 ");
    ...
    <div class="product_new">
        ...
        <div class="icon">
            ...
            <div class="row pd">
                <?php
                $sql_post= mysqli_query($con, "SELECT * FROM newpost WHERE status_display_post=1 LIMIT 3");
